   ...
   <xsl:template match="body | html:body">
     <fo:page-sequence master-reference="all-pages">
       <fo:static-content flow-name="page-header">
         <fo:block space-after="{$page-header-margin}" space-after.conditionality="retain" xsl:use-attribute-sets="page-header">
       ...
       <fo:static-content flow-name="page-footer">
         <fo:block space-before="{$page-footer-margin}" space-before.conditionality="retain" xsl:use-attribute-sets="page-footer">
